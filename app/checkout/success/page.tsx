...
//             yPos += 30;
//             ctx.fillText(
//               `Price per Ticket: ${transactionData.ticket.currency} ${transactionData.ticket.price.toLocaleString()}`,
//               40,
//               yPos,
//             );
//             yPos += 30;
...
//             ctx.fillText(
//               `Quantity: ${transactionData.transaction.buyers.length}`,
//               40,
//               yPos,
//             );
//             yPos += 50;
...
//             const subtotal = transactionData.ticket.price * totalBuyers;
...
//             ctx.fillText(
//               `${transactionData.ticket.currency} ${subtotal.toLocaleString()}`,
//               600,
//               yPos,
//             );
//             yPos += 30;
...
//             ctx.fillText(
//               `${transactionData.ticket.currency} ${serviceFee.toLocaleString()}`,
//               600,
//               yPos,
//             );
//             yPos += 40;
...
//             ctx.fillText(
//               `${transactionData.ticket.currency} ${total.toLocaleString()}`,
//               600,
//               yPos,
//             );
//             yPos += 50;
...
//             ctx.fillText(
//               "Thank you for your purchase! For support, contact support@dcave.com",
//               40,
//               yPos,
//             );
