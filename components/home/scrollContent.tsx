      ...
      >
        ...
        {items.map((item, index) => (
          <React.Fragment key={`first-${index}`}>
            <p className='bg-linear-to-r w-fit from-[#001D3D] via-[#CCA33A] to-[#004DA3] bg-clip-text text-transparent text-xl whitespace-nowrap font-bold'>
              {item}
            </p>
            <GoDotFill size={20} color='#CCA33A' className='shrink-0' />
          </React.Fragment>
        ))}
