    ...
    <div className="flex flex-col md:flex-row gap-4 sm:gap-6 bg-zinc-900 rounded-lg overflow-hidden max-w-8xl">
      ...
      <div className="md:w-1/2 py-6 px-4 sm:py-10 sm:px-8 lg:py-20 lg:px-14 flex flex-col justify-center">
        ...
        <button 
          ...
          className="bg-[#cca33a] hover:bg-yellow-700 text-white font-semibold py-3 sm:py-4 px-6 sm:px-8 rounded-full transition-colors duration-200 flex items-center justify-center gap-2 group text-sm sm:text-base w-full sm:w-auto xs:text-base active:scale-95 touch-manipulation select-none"
        >
          View Event Details
